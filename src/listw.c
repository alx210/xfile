...
static char* shorten_mb_string(const char*, size_t, Boolean ltor);
 ...
 */
static char* shorten_mb_string(const char *sz, size_t max_chrs, Boolean ltor)
{
...
static size_t mb_strlen(const char *sz)
{
	size_t nbytes = strlen(sz);
	size_t nchrs = 0;
	size_t i = 0;
